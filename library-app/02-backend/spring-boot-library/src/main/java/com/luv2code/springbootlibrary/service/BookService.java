...
import com.luv2code.springbootlibrary.reponsemodels.ShelfCurrentLoansResponse;
...
public class BookService {
    ...
    public Book checkoutBook(String userEmail, Long bookId) throws Exception {
        ...
        boolean bookedNeedsReturned = false;
        ...
        if ((userPayment != null && userPayment.getAmount() > 0) || (userPayment != null && bookedNeedsReturned)) {
