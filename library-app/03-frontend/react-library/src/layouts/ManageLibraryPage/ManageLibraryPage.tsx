...
export const ManageLibraryPage = () => {
    ...
    function addBookClickFuntcion() {
        setChangeQuantityOfBooksClick(false);
        setMessagesClick(false);
    }

    function chanegQuantityOfBooksClickFunction() {
            ...
            <div className="mt-5">
                ...
                <nav>
                    <div className="nav nav-tabs" id="nav-tab" role='tablist'>
                        <button onClick={addBookClickFuntcion} className="nav-link active" id='nav-add-book-tab' data-bs-toggle='tab'
                            data-bs-target="#nav-add-book" type="button" role="tab" aria-controls="nav-add-book"
                            aria-selected='false'>
                                Add new book
                        </button>
                        <button onClick={chanegQuantityOfBooksClickFunction} className="nav-link" id='nav-quantity-tab' data-bs-toggle='tab'
